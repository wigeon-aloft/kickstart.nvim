...
-- Configure vim-rooter to run automatically
vim.g.rooter_manual_only = false
...
vim.o.guicursor = "n-v-c-sm:block-blinkwait800-blinkoff300-blinkon500,i-ci-ve:ver25,r-cr-o:hor20"
